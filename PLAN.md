...
- The tracked Git checkout is being prepared for the `1.2.2` corrective release.
...
1. Commit and push the `1.2.2` corrective release from `/home/jameswilson/.openclaw/workspace/projects/oneclickcontent/repos/oneclickcontent-images`.
2. Publish the `1.2.2` GitHub release so the WordPress.org deployment workflow runs.
