...
- The tracked Git checkout is being prepared for the `1.2.1` release.
...
1. Commit and push the `1.2.1` release prep from `/home/jameswilson/.openclaw/workspace/projects/oneclickcontent/repos/oneclickcontent-images`.
2. Publish the `1.2.1` GitHub release so the WordPress.org deployment workflow runs.
